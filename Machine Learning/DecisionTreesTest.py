...
def target_selection(data):
    ...
    data = data[
        ['origin', 'destination', 'bandwidth', 'S0', 'S1', 'S2', 'E0', 'E1', 'E2', 'E3', 'E4', 'E5', 'E6', 'E7', 'E8',
         ...
         'E25', 'E26', 'E27', 'N0', 'N1', 'N2', 'N3', 'N4', 'N5', 'N6', 'N7', 'N8', 'N9', 'N10', 'RN0S0', 'RN1S0',
         'RN2S0',
         'RN3S0', 'RN4S0', 'RN5S0', 'RN6S0', 'RN7S0', 'RN8S0', 'RN9S0', 'RN10S0', 'RNExeS0', 'RN0S1', 'RN1S1', 'RN2S1',
         'RN3S1', 'RN4S1',
         'RN5S1', 'RN6S1', 'RN7S1', 'RN8S1', 'RN9S1', 'RN10S1', 'RNExeS1', 'RN0S2', 'RN1S2', 'RN2S2', 'RN3S2', 'RN4S2',
         'RN5S2',
         'RN6S2', 'RN7S2', 'RN8S2', 'RN9S2', 'RN10S2', 'RNExeS2']]
    ...
    target = data[['RN0S0', 'RN1S0', 'RN2S0',
                   'RN3S0', 'RN4S0', 'RN5S0', 'RN6S0', 'RN7S0', 'RN8S0', 'RN9S0', 'RN10S0', 'RNExeS0', 'RN0S1', 'RN1S1',
                   'RN2S1', 'RN3S1', 'RN4S1',
                   'RN5S1', 'RN6S1', 'RN7S1', 'RN8S1', 'RN9S1', 'RN10S1', 'RNExeS1', 'RN0S2', 'RN1S2', 'RN2S2', 'RN3S2',
                   'RN4S2', 'RN5S2',
                   'RN6S2', 'RN7S2', 'RN8S2', 'RN9S2', 'RN10S2', 'RNExeS2']]
    return features, target


def target_selectionTreated(data):
    """ Separates features from target
    :param: Dataframe
    :return: Features pandas.Dataframe
    :return: Target pandas.Series
    ...
    data = data[
        ['origin', 'destination', 'bandwidth', 'S0', 'S1', 'S2', 'E0', 'E1', 'E2', 'E3', 'E4', 'E5', 'E6', 'E7', 'E8',
         'E9', 'E10', 'E11', 'E12', 'E13', 'E14', 'E15', 'E16', 'E17', 'E18', 'E19', 'E20', 'E21', 'E22', 'E23', 'E24',
         'E25', 'E26', 'E27', 'N0', 'N1', 'N3', 'N4', 'N7', 'N8', 'N9', 'N10', 'RN1S0',
          'RN4S0', 'RN9S0', 'RN10S0', 'RNExeS0', 'RN0S1', 'RN3S1','RN7S1', 'RN9S1', 'RNExeS1', 'RN0S2', 'RN1S2', 'RN3S2',
          'RN7S2', 'RN8S2', 'RNExeS2']]
...
def training_setup(data):
    ...
    (training_inputs, testing_inputs, training_classes, testing_classes) = train_test_split(features_encoded,
                                                                                            target_encoded,
                                                                                            train_size=0.75,
                                                                                            random_state=1)
    num_classes = 36
...
def dynamically_training(path_Nos_originaldata,newData,path_to_output, plots=False,
                         hyperparameter_tuning=False, n_jobs=1):
    ...
    data2 = load_data(newData)

    original_data = load_data(path_Nos_originaldata)
    original_data.dropna(inplace=True)
    data = original_data

    training_inputs1, testing_inputs1, training_classes1, testing_classes1, features_encoded1, target_encoded1, num_classes1 = training_setup(
        data2)
...
dynamically_training("C:\\Users\\gcama\\Desktop\\Dissertacao\\Work\\MachineLearning\\Data_Set_2\\DecisionTrees\\50000\\DT_50000_training.csv",
                     "C:\\Users\\gcama\\Desktop\\Dissertacao\\Work\\MachineLearning\\Data_Set_2\\DecisionTrees\\PredictingInput/DT_predictingInput.csv",path,False,hyperparameter, n_jobs_global)
