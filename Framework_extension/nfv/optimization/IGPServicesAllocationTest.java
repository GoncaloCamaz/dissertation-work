...
import pt.uminho.algoritmi.netopt.nfv.optimization.jecoli.JecoliServIGP;
...
public class IGPServicesAllocationTest
{
    /*
    ...
    */
    public static void main(String[] args) throws Exception {
        ...
        JecoliServIGP ea = new JecoliServIGP(topology,state,lowerBound,upperBound, serviceMapingFile, maxServices,cplexTimeLimit);
    ...
    public static void save(Population p, int limit) {
        ...
        FileWriter f;
        try {
            f = new FileWriter("SERVICES_IGP_ServLimit_"+limit +"_"+ System.currentTimeMillis() + ".csv", true);
