...
public class PopulationNFV implements Serializable
{
    ...
    public PopulationNFV(int nObjectives) {
    ...
    public PopulationNFV(ASolutionSet<Integer> population) {
        this.data = new ArrayList<IntegerSolution>();
    ...
    public PopulationNFV(List<IntegerSolution> set) {
        this.data = new ArrayList<IntegerSolution>();
    ...
    public PopulationNFV copy(int numberOfObjectives) {
        ...
        PopulationNFV p = new PopulationNFV(set);
        return p;
    }
    ...
    public int[] getNodes(int index) throws NullPointerException{
