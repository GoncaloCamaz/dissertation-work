...
public class NFV_MCFPMLUSolver_2
{
    ...
    public NFV_MCFPMLUSolver_2(NetworkTopology topology, NFServicesMap servicesMap, NFRequestsMap r,
                             NFNodesMap n) {
    ...
    public NFV_MCFPMLUSolver_2(NetworkTopology topology, NFVState state, int timelimit) {
        this.topology = topology;
    ...
    public static void main(String[] args) throws Exception {
        ...
        NFV_MCFPMLUSolver_2 solver = new NFV_MCFPMLUSolver_2(topology,state,30);
